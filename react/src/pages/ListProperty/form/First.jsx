...
const First = ({ formData, setFormData }) => {
    return ( 
        <div className='input-form'>
            ...
            {/* ---------- */}
{/* 
            <label htmlFor="title"><span>* </span>Name</label>
            <input type="text" name="title" placeholder='hotel name' value={formData.name} id="name" onChange={(e) => {setFormData({ ...formData, name: e.target.value })}}/>    
             */}
